...
const CoinCollector = () => {
  ...
  return (
    ...
    <h3>
        <span style={{color:'red',paddingRight:"10px"}}>Coin:{state.coin}</span>
        <span style={{color:'blue',paddingRight:"10px"}}>Bonus:{state.bonus}</span>
        <span style={{color:'green',paddingRight:"10px"}}>LEVEL:{state.level}</span>
